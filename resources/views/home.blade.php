                        ...
                        <li class="nav-item" style="position: relative">
                           <a class="nav-link" href="{{ route('cart') }}">
                              ...
                              <i class='bx bx-cart-add' style="font-size: 20px; position:relative">
                                 @if($cart==0)
                                 <span style="position: absolute; top:-12px;left:7px ; color:white; font-weight:bold ;content:''; border-radius:50%;padding:1.5px" ></span>
                                 @else
                                 <span style="position: absolute; top:-10px;left:7px ; color:white ;content:''; background-color:red; border-radius:50%;padding:px" >{{ $cart }}</span>
                                 @endif
         ...
         <div class="container">
            ...
            <form action="{{ route('search') }}" class="form" method="GET">
               ...
               <div class="input-group mb-3">
                   <input type="text" class="form-control" required name="product" placeholder="search" aria-label="">
                  ...
                  <div class="box">
                     <div class="option_container">
                        <div class="options">
                         ...
                         Product Details
                           ...
                           <form action="{{ route('order',$product->id) }} " method="POST" enctype="multipart/form-data" >
                              @csrf
                              <input type="number" class=" rounded-pill " required placeholder="number" style="width: 170px; height:40px" name="quantity" id="" min="1">
                        
                              <input type="submit" name="" class="btn btn-dark" id="" value="Add Cart">
                           </form>
                        </div>
                     </div>
                     <div class="img-box">
                     ...
                     <div class="detail-box">
                        ...
                        <div class="d-flex  flex-column">
                           <h6 class="text-danger">Discount</h6>
                        <h6 class="text-danger">
                           <span >NGN {{ number_format($product->discount) }}</span>
                        </h6>
                        </div>
