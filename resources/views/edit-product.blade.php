      ...
      <!-- partial -->
        ...
        <div class="main-panel">
          <div class=" content-wrapper">
            ...
            <form action=" {{ route('edit',$products->id) }}" enctype="multipart/form-data" method="POST">
              @csrf
              <div class="main-panel">
              ...
              <div class="row mb-3">
                  ...
                  <div class="col-md-6">
                      <input id="title" type="text"value="{{ $products->title }}"
                      class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" required autocomplete="title" autofocus>
              ...
              <div class="row mb-3">
                  ...
                  <div class="col-md-6">
                      ...
                      type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" required autocomplete="description">
              ...
              <div class="row mb-3">
                  ...
                  <div class="col-md-6">
                      ...
                      class="form-control @error('price') is-invalid @enderror" name="price" required autocomplete="price">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="discount"value="{{ $products->discount }}"
                    type="text" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ old('discount') }}"  autocomplete="discount" autofocus>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                  ...
                  type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity') }}" required autocomplete="quantity" autofocus>
          ...
          <div class="col-md-6">
              ...
              <div class="row mb-0">
                  <div class="col-md-6 offset-md-4">
                   ...
                   <a href="{{ route('show_product') }} " class="btn btn-success mt-2">Back</a>
